...
func (self *cMock) GetRegDump(iface string) (map[string]string, error) {
	args := self.Mock.Called(iface)
	var r0 map[string]string = nil
	if args.Get(0) != nil {
		r0 = args.Get(0).(map[string]string)
...
func (self *cMock) GetDriverInfo(iface string) (string, error) {
	args := self.Mock.Called(iface)
